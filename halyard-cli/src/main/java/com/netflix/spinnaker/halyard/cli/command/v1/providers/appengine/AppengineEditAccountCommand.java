...
public class AppengineEditAccountCommand extends AbstractEditAccountCommand<AppengineAccount> {
  ...
  @Parameter(
    names = "--ssh-private-key-password",
    description = AppengineCommandProperties.SSH_PRIVATE_KEY_PASSWORD,
    password = true
  )
  ...
  protected Account editAccount(AppengineAccount account) {
    ...
    account.setSshPrivateKeyPassword(isSet(sshPrivateKeyPassword) ? sshPrivateKeyPassword: account.getSshPrivateKeyPassword());
