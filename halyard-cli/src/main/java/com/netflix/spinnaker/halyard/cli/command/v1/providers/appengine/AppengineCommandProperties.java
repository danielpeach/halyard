...
public class AppengineCommandProperties {
    ...
    static final String GIT_HTTPS_PASSWORD_DESCRIPTION = "A password to be used when connecting with a remote git"
            + " repository server over HTTPS.";
    static final String GITHUB_OAUTH_ACCESS_TOKEN_DESCRIPTION = "An OAuth token provided by Github for connecting to a git repository over HTTPS."
    ...
    static final String SSH_PRIVATE_KEY_PASSWORD = "The password to an SSH private key to be used"
